...
var Entities = newEntitiesTable("atlas-blue", "entities", "")
...
type entitiesTable struct {
	...
	MasterEntityUpdated                mysql.ColumnBool
...
// AS creates new EntitiesTable with assigned alias
func (a EntitiesTable) AS(alias string) *EntitiesTable {
	return newEntitiesTable(a.SchemaName(), a.TableName(), alias)
}

// Schema creates new EntitiesTable with assigned schema name
func (a EntitiesTable) FromSchema(schemaName string) *EntitiesTable {
	return newEntitiesTable(schemaName, a.TableName(), a.Alias())
}

// WithPrefix creates new EntitiesTable with assigned table prefix
func (a EntitiesTable) WithPrefix(prefix string) *EntitiesTable {
	return newEntitiesTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new EntitiesTable with assigned table suffix
func (a EntitiesTable) WithSuffix(suffix string) *EntitiesTable {
	return newEntitiesTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}

func newEntitiesTable(schemaName, tableName, alias string) *EntitiesTable {
	return &EntitiesTable{
		entitiesTable: newEntitiesTableImpl(schemaName, tableName, alias),
		NEW:           newEntitiesTableImpl("", "new", ""),
	}
}

func newEntitiesTableImpl(schemaName, tableName, alias string) entitiesTable {
	var (
		...
		MasterEntityUpdatedColumn                = mysql.BoolColumn("master_entity_updated")
		allColumns                               = mysql.ColumnList{IDColumn, ParentEntityColumn, LeadPartnerIDColumn, TypeIDColumn, CountryCodeColumn, NameColumn, AbbreviatedNameColumn, BranchSscNameColumn, StatusIDColumn, TestEntityCategoryIDColumn, PrimaryAddressColumn, PrimaryCityColumn, PrimaryStateProvinceCountryColumn, PrimaryPostalCodeColumn, PrimaryPhoneNumberColumn, PrimaryOtherPhoneNumberColumn, SecondaryAddressColumn, SecondaryCityColumn, SecondaryStateProvinceCountryColumn, SecondaryPostalCodeColumn, SecondaryPhoneNumberColumn, SecondaryOtherPhoneNumberColumn, HasNationalRegistrationColumn, NationalRegistrationNumberColumn, UniqueGlobalNumberColumn, DescriptionColumn, LegalFormIDColumn, DescriptionOfActivityColumn, NumberOfEmployeesColumn, ListedCompanyColumn, StockExchangeListingColumn, CountriesOfListingCodesColumn, PieColumn, OtherRelevantServicesProvidedBySscColumn, PeriodEndDateColumn, HasPreparingConsolidatedAccountsColumn, HasBusinessDivisionsColumn, HasBranchesColumn, HasSharedServicesCentresColumn, FrequencyOfConsolidationColumn, IsValidColumn, DeletedColumn, PackageToTestIdentifierColumn, PackageToTestVersionColumn, PackageToTestLastCommitHashColumn, IsMigratedColumn, LockedColumn, LockedAtColumn, MasterEntityIDColumn, MasterEntityUpdatedColumn}
	...
	return entitiesTable{
		...
		MasterEntityUpdated:                MasterEntityUpdatedColumn,
